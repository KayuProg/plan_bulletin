...
class frame_class(ft.Row):
    def __init__(self,frame_title):
        ...
        self.col=ft.Column(controls=[self.title_container,ft.Divider(color="white",height=1.5,thickness=1.5)],expand=True)#expandで横画面の大きさに合わせる,height,thicknessでdividerの幅設定．
